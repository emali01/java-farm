...
// File: contracts/interfaces/IJavaSwapLottery.sol

pragma solidity ^0.8.4;

interface IJavaSwapLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public javaSwapLottery;
     ...
     * @param _seed: seed provided by the JavaSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == javaSwapLottery, "Only JavaSwapLottery");
    ...
    /**
     * @notice Set the address for the JavaSwapLottery
     * @param _javaSwapLottery: address of the JavaSwap lottery
     */
    function setLotteryAddress(address _javaSwapLottery) external onlyOwner {
        javaSwapLottery = _javaSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IJavaSwapLottery(javaSwapLottery).viewCurrentLotteryId();
    }
}